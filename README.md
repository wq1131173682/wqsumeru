...
> **当前版本**: v1.4.8 · **更新日期**: 2026-09-06 · **完整变更**: [CHANGELOG.md](./CHANGELOG.md)
...
- **模块化架构**: 12个独立Skill模块（扫榜/迁移/选题/大纲/写作/审稿/评分/修稿/润色/完稿 + 1 个支撑模块），可单独调用也可全流程自动编排
...
├── wq-revise/        # 评分驱动·收敛式修稿，硬重试上限+定向重评，杜绝低分回头改死循环
