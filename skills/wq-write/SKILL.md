...
3. **反AI / 反水文扫描（v1.2.2 强约束）**：**必须**调用 `python skills/wq-review/scripts/anti-ai-scan.py chapters --outlines outlines/chapters.json --output .sumeru/review --quiet`。脚本退出码：
   - `0` = 通过，继续下一步
